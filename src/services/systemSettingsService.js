...
export const defaultSystemSettings = {
  ...
  finance: { platformFee: 8, caregiverCommission: 5, vat: 15, minimumWithdrawal: 500, payoutSchedule: "Weekly", refundWindow: 24, paymentMode: "Test", primaryGateway: "Stripe" },
  ...
  integrations: {
    providers: {
      ...
      stripe: { enabled: true, publicId: "Test Checkout", endpoint: "Hosted Checkout" },
